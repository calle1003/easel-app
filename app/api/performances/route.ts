  ...
  try {
    ...
    for (let i = 1; i <= numberOfShows; i++) {
      ...
      sessionsData.push({
        ...
        generalCapacity: sessionDate?.generalCapacity || 100,
        reservedCapacity: sessionDate?.reservedCapacity || 30,
        vip1Capacity: sessionDate?.vip1Capacity || 0,
        vip2Capacity: sessionDate?.vip2Capacity || 0,
        generalSold: 0,
        reservedSold: 0,
        vip1Sold: 0,
        vip2Sold: 0,
